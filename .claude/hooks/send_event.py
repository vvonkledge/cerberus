...
def send_event_to_server(event_data, server_url=None):
    ...
    if server_url is None:
        base = os.environ.get('SIANA_SERVER_URL', 'http://localhost:8787')
...
def main():
    ...
    parser.add_argument('--server-url', default=None, help='Server URL (default: $SIANA_SERVER_URL or http://localhost:8787/events)')
